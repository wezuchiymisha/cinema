        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Стоимость данного места составляет ${session.price}грн. Вы уверены, что хотите приобрести билет
                    на данное место?
                </div>
            ...
            <c:forEach items="${places}" var="place">
                <c:if test="${place.enabled}">
                    <button type="button" onclick="changePlace(${place.place.id})" data-toggle="modal"
                            data-target="#payModal" class="list-group-item list-group-item-action">${place.place.num}
                        место, ${place.place.row} ряд
                    </button>
                </c:if>
                <c:if test="${not place.enabled}">
                    <button type="button" class="list-group-item list-group-item-action" disabled>${place.place.num}
                        место, ${place.place.row} ряд
                    </button>
                </c:if>
            </c:forEach>
