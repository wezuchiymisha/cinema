							...
							<form:form method="POST" action="${contextPath}/register" modelAttribute="registerForm">
								...
								<div class="input-group form-group">
									...
									<spring:bind path="name">
										<form:input path="name" type="text" class="form-control ${error ? 'is-invalid' : ''}" placeholder="name"></form:input>
									</spring:bind>
								</div>
								<div class="input-group form-group">
									<div class="input-group-prepend">
									...
									<spring:bind path="surname">
										<form:input path="surname" type="text" class="form-control ${error ? 'is-invalid' : ''}" placeholder="surname"></form:input>
									</spring:bind>
								</div>
								<div class="input-group form-group">
									<div class="input-group-prepend">
								...
								<c:if test="${error}">
									<div class="alert alert-danger alert-dismissible fade show">Регистрация неуспешна</div>
								</c:if>
								<button class="btn btn-danger recordsColor justify-content-center" type="submit">Зарегестрироваться</button>
							</form:form>
						</div>
					</div>
                </div>
